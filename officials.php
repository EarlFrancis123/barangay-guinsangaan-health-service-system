...
<?php 
	$query = "SELECT o.name     AS 'official',
					o.chairmanship    AS 'chairmanship',
					o.position  AS 'position',
					o.termstart AS 'term_start',
					o.termend AS 'term_end',
					o.status 	AS 'status',
								...
								<div class="card-header">
									<div class="card-head-row">
										...
										<?php if(isset($_SESSION['username']) && $_SESSION['role']!='resident'): ?>
											...
											<a href="officials_add_form.php" class="btn btn-primary mr-1">
											...
											<tbody>
												<?php foreach($officials as $row): ?>
													<tr>
														...
														<?php if(isset($_SESSION['username']) && $_SESSION['role']!='resident'): ?>
														<td>
																	<a href="officials_update_form.php?id=<?= $row['id'] ?>" class="btn btn-link" data-toggle="tooltip" data-placement="top" title="Update">
																		<i class="fa fa-edit mr-2"></i>
																	</a>
																	<a href="remove_item.php?id=<?= $row['id'] ?>&tbl=tbl_officials&page=officials" class="btn btn-link btn-danger" onclick="return confirm('Are you sure you want to delete this item?');" data-toggle="tooltip" data-placement="top" title="Remove">
