...
<head>
	...
	<title>Resident - Barangay Guinsangaan Health Service System</title>
</head>
<body>
	<div class="wrapper">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="purok" name="purok" required>
														<option selected="true" disabled="disabled">--</option>
														<option>Purok Kahumayan 1</option>
														<option>Purok kahumayan 2</option>
														<option>Purok Lagnason</option>
														<option>Purok Lagnason 2</option>
														<option>Purok Kasagingan</option>
														<option>Purok Riverside</option>
														<option>Purok kanangkaan</option>
														<option>Purok Katambisan</option>
														<option>Purok Kasambagan</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
